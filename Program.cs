...
/*
Использование регулярных выражений (System.Text.RegularExpressions.Regex) было для меня новой темой, 
раньше я встречался с ней на прасторах stackoverflow, но не использовал.
Она казалась для меня чем то трудным и не понятным.
Но я решил её изучить и использовать в данной задачи,
это большой опыт и плюс к моим знаниям!
*/